...
class LTLSemantics(SemanticDefaults):
    ...
    # LTL-specific general settings defaults (derived from bimodal)
    ...
    def _reset_global_state(self):
        ...
        This implementation ensures that each new instance of LTLSemantics 
    ...
    def define_sorts(self):
        """Define the Z3 sorts used in the LTL logic model.
